...
public class KruskalMSTTest {
    ...
    public void KruskalMSTG1_2Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_1_2.txt");
    ...
    public void KruskalMSTG1_20Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_1_20.txt");
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG1_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_1_200.txt");
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG10_20Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_10_20.txt");
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG10_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_10_200.txt");
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG100_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_100_200.txt");
        Graph mst = kruskal.getMST(graph);
