...
public class KruskalMSTTest {
    ...
    public void KruskalMSTG1_20Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_1_20.txt", false, false);
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG1_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_1_200.txt", false, false);
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG10_20Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_10_20.txt", false, false);
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG10_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_10_200.txt", false, false);
        Graph mst = kruskal.getMST(graph);
    ...
    public void KruskalMSTG100_200Test() {
        Graph graph = importGraphFromFile("src/main/resources/p2/G_100_200.txt", false, false);
        Graph mst = kruskal.getMST(graph);
